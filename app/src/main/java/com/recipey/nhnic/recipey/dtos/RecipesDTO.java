...
public class RecipesDTO extends JSONObject {
    public RecipesDTO() {
        ...
        this.recipes.add(new Recipe((long)4, "https://ichef.bbci.co.uk/food/ic/food_16x9_832/recipes/chicken_tikka_masala_11482_16x9.jpg", "Chicken Tikki Masala"));
        this.recipes.add(new Recipe((long)5, "https://assets.vogue.com/photos/5a3aac8f0193fe386b1e3898/master/pass/vietnamese-food-holding.jpg", "Traditional Vietnamese Dinner"));
    }
